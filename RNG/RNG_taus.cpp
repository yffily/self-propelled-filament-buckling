...
RNG_taus::RNG_taus(const RNG_taus& other)
{
	s1 = other.s1;
	s2 = other.s2;
	s3 = other.s3;
	use_or_make = other.use_or_make;
}

RNG_taus& RNG_taus::operator = (const RNG_taus& other)
{
	s1 = other.s1;
	s2 = other.s2;
	s3 = other.s3;
...
//	static int use_or_make = 0;
	double & x = rng.x;
	double & y = rng.y;
	bool & use_or_make = rng.use_or_make;
 ...
 * number generation is unchanged by switching from random_normal to
...
void RNG_taus::get_state(unsigned long int & i1, unsigned long int & i2, unsigned long int & i3, double & x_, double & y_, bool & b)
	{
	i1 = s1;
	i2 = s2;
	i3 = s3;
...
void RNG_taus::set_state(unsigned long int i1, unsigned long int i2, unsigned long int i3, double x_, double y_, bool b)
	{
	s1 = i1;
	s2 = i2;
	s3 = i3;
